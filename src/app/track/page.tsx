...
import { Luggage, Search, MapPin, Clock, ArrowLeft, Package, Plane } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold text-white">Track Baggage</span>
          </div>
        </motion.div>
          ...
          <Card className="bg-white/10 backdrop-blur-lg border-white/20 mb-8">
            <CardHeader>
              ...
              <CardDescription className="text-gray-300">
                Enter your Baggage ID or PNR to track your luggage in real-time
              </CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  {baggage.trackingHistory && baggage.trackingHistory.length > 0 && (
                    <div className="mt-6">
                      ...
                      <div className="space-y-3">
                        {baggage.trackingHistory.map((event, eventIndex) => (
                          <div key={event.id} className="flex items-start space-x-3 p-3 bg-white/5 rounded-lg">
                            ...
                            <div className="flex-1">
                              ...
                              {event.scannedBy && (
                                <p className="text-gray-400 text-xs">Scanned by: {event.scannedBy}</p>
                              )}
                            </div>
                          </div>
                        ))}
